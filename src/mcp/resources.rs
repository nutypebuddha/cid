...
pub fn list_resources(kb: &KnowledgeBase) -> JsonValue {
    ...
    for fact in &kb.facts {
        ...
        resources.push(JsonValue::Object(vec![
            ...
            ("mimeType".to_string(), JsonValue::Str("application/json".to_string())),
        ]));
    }

    resources.push(JsonValue::Object(vec![
        ("uri".to_string(), JsonValue::Str("cid://schemas/validation".to_string())),
        ("name".to_string(), JsonValue::Str("Validation Result Schema".to_string())),
        ("description".to_string(), JsonValue::Str("JSON schema for CID validation results".to_string())),
        ("mimeType".to_string(), JsonValue::Str("application/schema+json".to_string())),
    ]));
...
pub fn list_prompts() -> JsonValue {
    JsonValue::Array(vec![
        JsonValue::Object(vec![
            ("name".to_string(), JsonValue::Str("validate_text".to_string())),
            ("description".to_string(), JsonValue::Str("Validate text through CID's gates and return results".to_string())),
            ("arguments".to_string(), JsonValue::Array(vec![
                JsonValue::Object(vec![
                    ("name".to_string(), JsonValue::Str("text".to_string())),
                    ("description".to_string(), JsonValue::Str("Text to validate".to_string())),
                    ("required".to_string(), JsonValue::Bool(true)),
                ]),
                JsonValue::Object(vec![
                    ("name".to_string(), JsonValue::Str("context".to_string())),
                    ("description".to_string(), JsonValue::Str("Domain context (math, fact, logic, english)".to_string())),
        ...
        JsonValue::Object(vec![
            ...
            ("description".to_string(), JsonValue::Str("Auto-fix errors in text (math, typos, consistency)".to_string())),
            ("arguments".to_string(), JsonValue::Array(vec![
                JsonValue::Object(vec![
                    ("name".to_string(), JsonValue::Str("text".to_string())),
                    ("description".to_string(), JsonValue::Str("Text to fix".to_string())),
                    ("required".to_string(), JsonValue::Bool(true)),
                ]),
                JsonValue::Object(vec![
                    ("name".to_string(), JsonValue::Str("context".to_string())),
                    ("description".to_string(), JsonValue::Str("Domain context (math, javascript, english)".to_string())),
                    ("required".to_string(), JsonValue::Bool(false)),
                ]),
            ])),
        ]),
        JsonValue::Object(vec![
            ("name".to_string(), JsonValue::Str("analyze_reasoning".to_string())),
            ("description".to_string(), JsonValue::Str("Analyze text for logical fallacies and cognitive biases".to_string())),
            ("arguments".to_string(), JsonValue::Array(vec![
                JsonValue::Object(vec![
                    ("name".to_string(), JsonValue::Str("text".to_string())),
                    ("description".to_string(), JsonValue::Str("Text to analyze".to_string())),
                    ("required".to_string(), JsonValue::Bool(true)),
                ]),
            ])),
        ]),
...
pub fn get_prompt(name: &str, arguments: &JsonValue) -> Result<JsonValue, String> {
    ...
    match name {
        "validate_text" => {
            let text = args.iter().find(|(k, _)| k == "text")
                .and_then(|(_, v)| v.as_str())
                .ok_or("Missing required argument: text")?;
            let context = args.iter().find(|(k, _)| k == "context")
                .and_then(|(_, v)| v.as_str())
                .unwrap_or("general");
        ...
        "fix_text" => {
            ...
            Ok(JsonValue::Object(vec![
                ("description".to_string(), JsonValue::Str(format!("Fix errors in '{}'", text))),
                ("messages".to_string(), JsonValue::Array(vec![
                    JsonValue::Object(vec![
                        ("role".to_string(), JsonValue::Str("user".to_string())),
                        ("content".to_string(), JsonValue::Str(format!(
        ...
        "analyze_reasoning" => {
            ...
            Ok(JsonValue::Object(vec![
                ("description".to_string(), JsonValue::Str("Analyze reasoning in text".to_string())),
                ("messages".to_string(), JsonValue::Array(vec![
                    JsonValue::Object(vec![
                        ("role".to_string(), JsonValue::Str("user".to_string())),
                        ("content".to_string(), JsonValue::Str(format!(
