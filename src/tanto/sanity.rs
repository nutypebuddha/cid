...
pub fn estimate(args: &str) -> Option<EstimateResult> {
    ...
    if v == 0.0 {
        return Some(EstimateResult {
            ...
            below_val: 0.0, below_name: String::new(),
            above_val: 0.0, above_name: String::new(),
        });
    }
