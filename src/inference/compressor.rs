...
impl PromptCompressor {
    ...
    pub fn compress(&self, prompt: &str) -> (String, CompressionStats) {
        ...
        if matches!(self.level, CompressionLevel::Medium | CompressionLevel::Aggressive) {
...
fn remove_filler_words(text: &str) -> String {
    static FILLER_WORDS: &[&str] = &[
        "please", "kindly", "just", "really", "very", "quite",
        "actually", "basically", "simply", "literally",
...
mod tests {
    ...
    fn test_compress_basic() {
        ...
        let (compressed, stats) = compressor.compress("Please kindly help me to understand this concept");
    ...
    fn test_compress_aggressive() {
        ...
        assert!(stats.saved_percent > 20.0, "Aggressive should save >20%, got {}%", stats.saved_percent);
    }
    ...
    fn test_polite_phrase_removal() {
        ...
        assert!(!compressed.contains("Could you please"), "Should remove polite phrase");
    }
