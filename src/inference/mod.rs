...
pub use result::{ValidationResult, TokenFix, GateScore, CidError, CidResult};
pub use request::{ValidationRequest, ProxyRequest, ProxyConfig, InferenceConfig};
pub use pipeline::Pipeline;
pub use fixer::TokenFixer;
pub use proxy::ProxyServer;
pub use stream::{StreamValidator, StreamEvent};
pub use compressor::{PromptCompressor, CompressionLevel, CompressionStats};
pub use cache::{SemanticCache, CacheHit, CacheStats};
pub use scorer::{ResponseScorer, QualityReport, SuggestedAction};

use crate::core::ball::Ball;
use crate::core::pocket::Pocket;
use crate::core::pin::Gate;
use crate::kb::facts::{KnowledgeBase, Fact};
...
impl InferenceEngine {
    ...
    pub fn validate_beam(&mut self, candidates: Vec<String>, context: &str) -> CidResult<Option<Pocket>> {
    ...
    pub fn validate_batch(&mut self, requests: Vec<ValidationRequest>) -> Vec<CidResult<ValidationResult>> {
